...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    event: Attribute.Relation<
      ...
      'api::event.event'
    >;
    signup: Attribute.Relation<
      'api::payment.payment',
      'oneToOne',
      'api::signup.signup'
    >;
    payment_identification: Attribute.UID;
    payment_data: Attribute.JSON;
    status: Attribute.Enumeration<
      ['PEDING_PAYMENT', 'CANCELED', 'CONFIRMED', 'REFUND']
    > &
      Attribute.DefaultTo<'PEDING_PAYMENT'>;
    confirmed_at: Attribute.DateTime;
...
export interface ApiSignupSignup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    payment: Attribute.Relation<
      ...
      'api::payment.payment'
    >;
    additional_information: Attribute.String;
    event: Attribute.Relation<
      'api::signup.signup',
      'manyToOne',
      'api::event.event'
